...
namespace VpNet
{
    ...
    public readonly struct ColorF : IEquatable<ColorF>
    {
        ...
        /// <summary>
        ///     Gets the alpha component value of this <see cref="ColorF" /> structure.
        /// </summary>
        /// <value>The alpha component value of this <see cref="ColorF" />.</value>
        public float A { get; }

        /// <summary>
        ///     Gets the red component value of this <see cref="ColorF" /> structure.
        /// </summary>
        /// <value>The red component value of this <see cref="ColorF" />.</value>
        public float R { get; }

        /// <summary>
        ///     Gets the green component value of this <see cref="ColorF" /> structure.
        /// </summary>
        /// <value>The green component value of this <see cref="ColorF" />.</value>
        public float G { get; }

        /// <summary>
        ///     Gets the blue component value of this <see cref="ColorF" /> structure.
        /// </summary>
        ...
        public static implicit operator ColorF(Color color) =>
            FromArgb(color.A / 255.0f, color.R / 255.0f, color.G / 255.0f, color.B / 255.0f);
        ...
        public static explicit operator Color(ColorF color) =>
            Color.FromArgb((int)(color.A * 255.0f), (int)(color.R * 255.0f), (int)(color.G * 255.0f), (int)(color.B * 255.0f));
        ...
        /// </exception>
        public static ColorF FromArgb(float r, float g, float b) => FromArgb(1.0f, r, g, b);
        ...
        /// <returns><see langword="true" /> if the two colors are equal; otherwise, <see langword="false" />.</returns>
        public bool Equals(ColorF other) => A.Equals(other.A) && R.Equals(other.R) && G.Equals(other.G) && B.Equals(other.B);
